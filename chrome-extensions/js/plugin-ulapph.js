            ...
            run: function(inVar, event) {
                ...
                if (this.isDataType('text')) {
                    ...
                    data.image_url = function(callback) {
                        ...
                        //ulapph
                        //ulapph - get the upload URL from ulapph server
                        //var xmlhttp;
                        ...
                        var ulapph_url = "";
                        var uploadURL = "";
                        ulapph_url = 'http://edwin-daen-vinas.appspot.com/editor?EDIT_FUNC=GET_UP_URL&SID=TDSMEDIA-x';
                        var xmlhttp = new XMLHttpRequest;
                        xmlhttp.open("POST",ulapph_url,true);
                        xmlhttp.send();
                         ...
                         xmlhttp.onreadystatechange=function()
                          ...
                          if (xmlhttp.readyState==4 && xmlhttp.status==200)
                            ...
                            //console.log("data.page_url: " + data.page_url);
                            //console.log("imageData: " + imageData);
                            var formData = new FormData();

                            formData.append("DATA_TYPE", "image");
                            //formData.append("SID", urlParams["SID"]);
                            formData.append("TITLE", data.page_title);
                            formData.append("DESC", data.page_description);
                            formData.append("FILE_NAME", data.page_url);           

                            //var blob = new Blob([imageData], { type: "image/png"});
                             dataURItoBlob=function(this) {
                             ...
                             imgBlob=dataURItoBlob(imageData.img_url)
